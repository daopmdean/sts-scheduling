    ...
    public class Testing
    {
        ...
        public static List<ShiftAssignment> GenerateShiftAssignments()
        {
            ...
            list.Add(new ShiftAssignment
            {
                Username = "mystaff01",
                SkillId = 21,
                TimeStart = new DateTime(2021, 07, 14, 9, 30, 0),
                TimeEnd = new DateTime(2021, 07, 14, 17, 30, 0)
            });
            list.Add(new ShiftAssignment
            {
                Username = "mystaff01",
                SkillId = 21,
                TimeStart = new DateTime(2021, 07, 15, 7, 0, 0),
                TimeEnd = new DateTime(2021, 07, 15, 13, 0, 0)
            });
            list.Add(new ShiftAssignment
            {
                Username = "mystaff02",
            ...
            list.Add(new ShiftAssignment
            {
                Username = "mystaff02",
                SkillId = 18,
                TimeStart = new DateTime(2021, 07, 16, 07, 00, 00),
                TimeEnd = new DateTime(2021, 07, 16, 15, 0, 0)
            });
            list.Add(new ShiftAssignment
            {
                Username = "mystaff02",
                SkillId = 18,
                TimeStart = new DateTime(2021, 07, 17, 07, 00, 00),
                TimeEnd = new DateTime(2021, 07, 17, 15, 0, 0)
            });
            list.Add(new ShiftAssignment
            {
                Username = "mystaff03",
